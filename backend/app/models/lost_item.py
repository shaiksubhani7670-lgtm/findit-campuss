...
class LostItem(db.Model):
    """
    Lost item report submitted by a student.
    """
    ...
    # Relationships
    matches = db.relationship('Match', backref='lost_item', lazy='dynamic', foreign_keys='Match.lost_report_id', cascade='all, delete-orphan')
